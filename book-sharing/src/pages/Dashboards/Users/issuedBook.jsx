...
const getFileSize = async (versionLabel) => {
  try {
    ...
    setFileSize(formatted.length > 0 ? formatted.join(" | ") : "Size not available");
  } catch (error) {
        ...
        <div className="action-buttons">
          ...
          {downloadUrl ? (
            <>
              ...
              <button className="btn-learn-more" onClick={handleDownloadCover}>
                Download Cover
              </button>
              ...
              <div key={book.book_id || book.book_id} className="book-card">
                ...
                <div className="book-card-content">
                  ...
                  <div className="book-card-meta">
                    ...
                    <span>
                      <strong>Country:</strong>{" "}
                      {book.country || book.country_name || "N/A"}
                    </span>
                    <span>
